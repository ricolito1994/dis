...
if (!isset ( $_SESSION ['PASSWORD'] ) && $current_page != 'login' ) header('Location: /dis/login');
		

if (isset ( $_SESSION ['PASSWORD'] ) && $current_page == 'login') 	header('Location: /dis');
...
?>
<title><?php ECHO isset($_SESSION['COMPANY_NAME']) ? $_SESSION['COMPANY_NAME'] : 'District Information System 1.0';  ?></title>
<meta charset="utf-8">
