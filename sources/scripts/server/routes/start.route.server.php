...
/* require "$root/dis/sources/scripts/server/classes/connection.server.class.php";
require "$root/dis/sources/scripts/server/classes/registry.server.class.php";
require "$root/dis/sources/scripts/server/classes/controller.server.class.php"; */
